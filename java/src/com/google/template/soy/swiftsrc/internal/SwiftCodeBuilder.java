...
public final class SwiftCodeBuilder {
	  ...
	  abstract static class OutputVar {
	    static OutputVar create(String name, boolean isInited) {
	      return new AutoValue_SwiftCodeBuilder_OutputVar(name, isInited);
	    }
	  ...
	  void addToOutputVar(List<? extends SwiftExpr> pyExprs) {
	    addToOutputVar(SwiftExprUtils.concatSwiftExprs(pyExprs));
	  }

	  /** Add a single SwiftExpr object to the output variable. */
	  void addToOutputVar(SwiftExpr SwiftExpr) {
	    boolean isList = SwiftExpr instanceof SwiftListExpr;
	    if (isList && !getOutputVarIsInited()) {
	      appendLine(getOutputVarName(), " = ", SwiftExpr.getText());
	    } else {
	      initOutputVarIfNecessary();
	      String function = isList ? ".extend(" : ".append(";
	      appendLine(getOutputVarName(), function, SwiftExpr.getText(), ")");
	    }
	    setOutputVarInited();
	  }
	   ...
	   * String.
	   *
	   * @return A SwiftExpr object of the output joined into a String.
	   */
	  SwiftStringExpr getOutputAsString() {
	    Preconditions.checkState(getOutputVarName() != null);

	    initOutputVarIfNecessary();
	    return new SwiftStringExpr(getOutputVarName(), Integer.MAX_VALUE).toSwiftString();
	  }
	   ...
	   */
	  public SwiftCodeBuilder append(String... codeFragments) {
	   ...
	   * @return This CodeBuilder (for stringing together operations).
	   */
	  public SwiftCodeBuilder appendLine(String... codeFragments) {
	    code.append(indent);
	   ...
	   * @return This CodeBuilder (for stringing together operations).
	   */
	  public SwiftCodeBuilder appendLineStart(String... codeFragments) {
	    code.append(indent);
	    append(codeFragments);
	    return this;
	  }
	   ...
	   * @return This CodeBuilder (for stringing together operations).
	   */
	  public SwiftCodeBuilder appendLineEnd(String... codeFragments) {
	    append(codeFragments);
	    code.append("\n");
	    return this;
	  }
	   ...
	   * @return This CodeBuilder (for stringing together operations).
	   */
	  SwiftCodeBuilder appendOutputVarName() {
